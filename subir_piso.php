...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST['subir_piso'])) {
            $con->insertar_vivienda(
                $_POST['venta_alquiler'],
                $_POST['metros'],
                $_POST['lavavo'],
                $_POST['habitacion'],
                $_POST['planta'],
    ...
    <form method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>" enctype="multipart/form-data">
        ...
        <div id="formulario">
            ...
            <div class="mb-3">
                <label for="portal" style="width: 200px;" class="form-label">Portal:</label>
                <input type="text" style="width: 400px;" id="portal" class="form-control" name="portal" required>
            </div>
            <div class="mb-3">
                <label for="escalera" style="width: 200px;" class="form-label">Escalera:</label>
                <input type="text" style="width: 400px;" id="escalera" class="form-control" name="escalera">
            </div>
            <div class="mb-3">
                <label for="puerta" style="width: 200px;" class="form-label">Puerta:</label>
                <input type="text" style="width: 400px;" id="puerta" class="form-control" name="puerta" required>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                <label for="imagen" style="width: 200px;" class="form-label">Imagen del piso:</label>
