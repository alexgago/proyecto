                        ...
                        <div class="row align-items-center">
                            <div class="col">
                                <div class="card text-center" style="width: 18rem;">
                                    <a href="administrar_local.php"><img src="img/admin_local.jpg" class="card-img-top" alt="..."></a>
                                    <div class="card-body ">
                            ...
                            <div class="col">
                                <div class="card text-center" style="width: 18rem;">
                                    <a href="administrar_vivienda.php"><img src="img/admi_vivienda.jpg" class="card-img-top" alt="..."></a>
                                    <div class="card-body">
                            ...
                            <div class="col">
                                <div class="card text-center" style="width: 18rem;">
                                    <a href="administrar_usuarios.php"><img src="img/admin_usuario.jpg" class="card-img-top" alt="..."></a>
                                    <div class="card-body">
