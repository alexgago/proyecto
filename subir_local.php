...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        if (isset($_POST['subir_local'])) {
            $con->insertar_establecimiento($_POST['venta_alquiler'], $_POST['metros'], $_POST['lavavo'], $_POST['habitacion'], $_POST['plantas'], $$_POST['puerta'], $_POST['calle'], $_POST['municipio'], $_POST['cod_postal'], $_POST['precio']);
    ...
    <form method="POST" action="<?php echo $_SERVER["PHP_SELF"]; ?>">
        ...
        <input type="submit" name="subir_local" class="btn btn-primary" value="Enviar">
    </form>
